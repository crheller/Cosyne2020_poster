...
ap_df = ld.load_dprime('refTar_pca4_dprime_act_pass_sim2_binPreLick')
apb_df = ld.load_dprime('refTar_pca4_dprime_bigPass_smallPass_sim2_binPreLick')
aps_df = ld.load_dprime('refTar_pca4_dprime_act_smallPass_sim2_binPreLick')
