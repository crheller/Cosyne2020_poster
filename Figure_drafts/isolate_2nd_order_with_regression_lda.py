...
ap_df = ld.load_dprime('refTar_pca3_dprime_pr_br_act_pass_LDA_binPreLick')
apb_df = ld.load_dprime('refTar_pca3_dprime_pr_br_bigPass_smallPass_LDA_binPreLick')
aps_df = ld.load_dprime('refTar_pca3_dprime_pr_br_act_smallPass_LDA_binPreLick')
